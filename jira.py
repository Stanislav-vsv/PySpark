...
try:
    ...
    if initial_load == 'y':
        response = paging_for_issues("19101", "type",
...
description, duedate, issuetype, project, resolutiondate, status, updated, summary, subtasks_key FROM {issues_temp_view}
"""
...
SELECT
id, key, self, assignee, created, creator,
description, duedate, issuetype, project, resolutiondate, status, updated, summary, subtasks_key
